...
ALTER TABLE t_chamado
    ADD CONSTRAINT t_chamado_t_produto_fk FOREIGN KEY ( nm_produto )
...
ALTER TABLE t_pedido_item
    ADD CONSTRAINT t_pedido_item_t_produto_fk FOREIGN KEY ( nm_produto )
        REFERENCES t_produto ( nm_produto );
...
ALTER TABLE t_video_produto
    ADD CONSTRAINT t_video_produto_t_produto_fk FOREIGN KEY ( nm_produto )
        REFERENCES t_produto ( nm_produto );
